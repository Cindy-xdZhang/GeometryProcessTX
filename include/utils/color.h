...
namespace color
{
    ...
    // Maya
    const float MAYA_GREEN[4] = {128. / 255., 242. / 255., 0. / 255., 1.};
    const float MAYA_YELLOW[4] = {255. / 255., 247. / 255., 50. / 255., 1.};
    const float MAYA_RED[4] = {234. / 255., 63. / 255., 52. / 255., 1.};
    const float MAYA_BLUE[4] = {0. / 255., 73. / 255., 252. / 255., 1.};
    const float MAYA_PURPLE[4] = {180. / 255., 73. / 255., 200. / 255., 1.};
    const float MAYA_VIOLET[4] = {31. / 255., 15. / 255., 66. / 255., 1.};
    const float MAYA_GREY[4] = {0.5, 0.5, 0.5, 1.0};
    const float MAYA_CYAN[4] = {131. / 255., 219. / 255., 252. / 255., 1.};
    const float MAYA_SEA_GREEN[4] = {70. / 255., 252. / 255., 167. / 255., 1.};
}

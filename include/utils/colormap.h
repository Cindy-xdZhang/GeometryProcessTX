#ifndef UTILS_COLORMAP_H
#define UTILS_COLORMAP_H

#include <algorithm>
#include <Eigen/Dense>


// One of the new matplotlib colormaps by Nathaniel J.Smith, Stefan van der
// Walt, and (in the case of viridis) Eric Firing.
...
namespace colormap
{
    enum ColorMapType
    {
        ...
        COLOR_MAP_TYPE_RED_WHITE_BLUE = 7,
        NUM_COLOR_MAP_TYPES = 8
    };

    static double red_white_blue_cm[256][3] = {
            {0.0000, 0.0000, 0.5000},
            {0.0000, 0.0079, 0.5079},
            {0.0000, 0.0157, 0.5157},
            {0.0000, 0.0236, 0.5236},
            {0.0000, 0.0315, 0.5315},
            {0.0000, 0.0394, 0.5394},
            {0.0000, 0.0472, 0.5472},
            {0.0000, 0.0551, 0.5551},
            {0.0000, 0.0630, 0.5630},
            {0.0000, 0.0709, 0.5709},
            {0.0000, 0.0787, 0.5787},
            {0.0000, 0.0866, 0.5866},
            {0.0000, 0.0945, 0.5945},
            {0.0000, 0.1024, 0.6024},
            {0.0000, 0.1102, 0.6102},
            {0.0000, 0.1181, 0.6181},
            {0.0000, 0.1260, 0.6260},
            {0.0000, 0.1339, 0.6339},
            {0.0000, 0.1417, 0.6417},
            {0.0000, 0.1496, 0.6496},
            {0.0000, 0.1575, 0.6575},
            {0.0000, 0.1654, 0.6654},
            {0.0000, 0.1732, 0.6732},
            {0.0000, 0.1811, 0.6811},
            {0.0000, 0.1890, 0.6890},
            {0.0000, 0.1969, 0.6969},
            {0.0000, 0.2047, 0.7047},
            {0.0000, 0.2126, 0.7126},
            {0.0000, 0.2205, 0.7205},
            {0.0000, 0.2283, 0.7283},
            {0.0000, 0.2362, 0.7362},
            {0.0000, 0.2441, 0.7441},
            {0.0000, 0.2520, 0.7520},
            {0.0000, 0.2598, 0.7598},
            {0.0000, 0.2677, 0.7677},
            {0.0000, 0.2756, 0.7756},
            {0.0000, 0.2835, 0.7835},
            {0.0000, 0.2913, 0.7913},
            {0.0000, 0.2992, 0.7992},
            {0.0000, 0.3071, 0.8071},
            {0.0000, 0.3150, 0.8150},
            {0.0000, 0.3228, 0.8228},
            {0.0000, 0.3307, 0.8307},
            {0.0000, 0.3386, 0.8386},
            {0.0000, 0.3465, 0.8465},
            {0.0000, 0.3543, 0.8543},
            {0.0000, 0.3622, 0.8622},
            {0.0000, 0.3701, 0.8701},
            {0.0000, 0.3780, 0.8780},
            {0.0000, 0.3858, 0.8858},
            {0.0000, 0.3937, 0.8937},
            {0.0000, 0.4016, 0.9016},
            {0.0000, 0.4094, 0.9094},
            {0.0000, 0.4173, 0.9173},
            {0.0000, 0.4252, 0.9252},
            {0.0000, 0.4331, 0.9331},
            {0.0000, 0.4409, 0.9409},
            {0.0000, 0.4488, 0.9488},
            {0.0000, 0.4567, 0.9567},
            {0.0000, 0.4646, 0.9646},
            {0.0000, 0.4724, 0.9724},
            {0.0000, 0.4803, 0.9803},
            {0.0000, 0.4882, 0.9882},
            {0.0000, 0.4961, 0.9961},
            {0.0079, 0.5039, 1.0000},
            {0.0236, 0.5118, 1.0000},
            {0.0394, 0.5197, 1.0000},
            {0.0551, 0.5276, 1.0000},
            {0.0709, 0.5354, 1.0000},
            {0.0866, 0.5433, 1.0000},
            {0.1024, 0.5512, 1.0000},
            {0.1181, 0.5591, 1.0000},
            {0.1339, 0.5669, 1.0000},
            {0.1496, 0.5748, 1.0000},
            {0.1654, 0.5827, 1.0000},
            {0.1811, 0.5906, 1.0000},
            {0.1969, 0.5984, 1.0000},
            {0.2126, 0.6063, 1.0000},
            {0.2283, 0.6142, 1.0000},
            {0.2441, 0.6220, 1.0000},
            {0.2598, 0.6299, 1.0000},
            {0.2756, 0.6378, 1.0000},
            {0.2913, 0.6457, 1.0000},
            {0.3071, 0.6535, 1.0000},
            {0.3228, 0.6614, 1.0000},
            {0.3386, 0.6693, 1.0000},
            {0.3543, 0.6772, 1.0000},
            {0.3701, 0.6850, 1.0000},
            {0.3858, 0.6929, 1.0000},
            {0.4016, 0.7008, 1.0000},
            {0.4173, 0.7087, 1.0000},
            {0.4331, 0.7165, 1.0000},
            {0.4488, 0.7244, 1.0000},
            {0.4646, 0.7323, 1.0000},
            {0.4803, 0.7402, 1.0000},
            {0.4961, 0.7480, 1.0000},
            {0.5118, 0.7559, 1.0000},
            {0.5276, 0.7638, 1.0000},
            {0.5433, 0.7717, 1.0000},
            {0.5591, 0.7795, 1.0000},
            {0.5748, 0.7874, 1.0000},
            {0.5906, 0.7953, 1.0000},
            {0.6063, 0.8031, 1.0000},
            {0.6220, 0.8110, 1.0000},
            {0.6378, 0.8189, 1.0000},
            {0.6535, 0.8268, 1.0000},
            {0.6693, 0.8346, 1.0000},
            {0.6850, 0.8425, 1.0000},
            {0.7008, 0.8504, 1.0000},
            {0.7165, 0.8583, 1.0000},
            {0.7323, 0.8661, 1.0000},
            {0.7480, 0.8740, 1.0000},
            {0.7638, 0.8819, 1.0000},
            {0.7795, 0.8898, 1.0000},
            {0.7953, 0.8976, 1.0000},
            {0.8110, 0.9055, 1.0000},
            {0.8268, 0.9134, 1.0000},
            {0.8425, 0.9213, 1.0000},
            {0.8583, 0.9291, 1.0000},
            {0.8740, 0.9370, 1.0000},
            {0.8898, 0.9449, 1.0000},
            {0.9055, 0.9528, 1.0000},
            {0.9213, 0.9606, 1.0000},
            {0.9370, 0.9685, 1.0000},
            {0.9528, 0.9764, 1.0000},
            {0.9685, 0.9843, 1.0000},
            {0.9843, 0.9921, 1.0000},
            ...
            {0.9724, 0.0000, 0.0000},
            {0.9646, 0.0000, 0.0000},
            {0.9567, 0.0000, 0.0000},
            {0.9488, 0.0000, 0.0000},
            {0.9409, 0.0000, 0.0000},
            {0.9331, 0.0000, 0.0000},
            {0.9252, 0.0000, 0.0000},
            {0.9173, 0.0000, 0.0000},
            {0.9094, 0.0000, 0.0000},
            {0.9016, 0.0000, 0.0000},
            {0.8937, 0.0000, 0.0000},
            {0.8858, 0.0000, 0.0000},
            {0.8780, 0.0000, 0.0000},
            {0.8701, 0.0000, 0.0000},
            {0.8622, 0.0000, 0.0000},
            {0.8543, 0.0000, 0.0000},
            {0.8465, 0.0000, 0.0000},
            {0.8386, 0.0000, 0.0000},
            {0.8307, 0.0000, 0.0000},
            {0.8228, 0.0000, 0.0000},
            {0.8150, 0.0000, 0.0000},
            {0.8071, 0.0000, 0.0000},
            {0.7992, 0.0000, 0.0000},
            {0.7913, 0.0000, 0.0000},
            {0.7835, 0.0000, 0.0000},
            {0.7756, 0.0000, 0.0000},
            {0.7677, 0.0000, 0.0000},
            {0.7598, 0.0000, 0.0000},
            {0.7520, 0.0000, 0.0000},
            {0.7441, 0.0000, 0.0000},
            {0.7362, 0.0000, 0.0000},
            {0.7283, 0.0000, 0.0000},
            {0.7205, 0.0000, 0.0000},
            {0.7126, 0.0000, 0.0000},
            {0.7047, 0.0000, 0.0000},
            {0.6969, 0.0000, 0.0000},
            {0.6890, 0.0000, 0.0000},
            {0.6811, 0.0000, 0.0000},
            {0.6732, 0.0000, 0.0000},
            {0.6654, 0.0000, 0.0000},
            {0.6575, 0.0000, 0.0000},
            {0.6496, 0.0000, 0.0000},
            {0.6417, 0.0000, 0.0000},
            {0.6339, 0.0000, 0.0000},
            {0.6260, 0.0000, 0.0000},
            {0.6181, 0.0000, 0.0000},
            {0.6102, 0.0000, 0.0000},
            {0.6024, 0.0000, 0.0000},
            {0.5945, 0.0000, 0.0000},
            {0.5866, 0.0000, 0.0000},
            {0.5787, 0.0000, 0.0000},
            {0.5709, 0.0000, 0.0000},
            {0.5630, 0.0000, 0.0000},
            {0.5551, 0.0000, 0.0000},
            {0.5472, 0.0000, 0.0000},
            {0.5394, 0.0000, 0.0000},
            {0.5315, 0.0000, 0.0000},
            {0.5236, 0.0000, 0.0000},
            {0.5157, 0.0000, 0.0000},
            {0.5079, 0.0000, 0.0000},
    ...
    // Inputs:
    //   c  colormap enum
    //   x  factor determining color value as if 0 was min and 1 was max
    // Outputs:
    //   rgb  red, green, blue value
    template<typename T>
    inline void colormap(const ColorMapType cm, const T x, T* rgb)
    {
            ...
            const ColorMapType cm, const T x_in, T& r, T& g, T& b)
    {
        switch (cm)
        {
            case COLOR_MAP_TYPE_RED_WHITE_BLUE:
                colormap(red_white_blue_cm, x_in, r, g, b);
                break;
            ...
            case COLOR_MAP_TYPE_VIRIDIS:
                ...
                break;
            default:
                throw std::invalid_argument("colormap::colormap(): Selected colormap is unsupported!");
        }
    }
